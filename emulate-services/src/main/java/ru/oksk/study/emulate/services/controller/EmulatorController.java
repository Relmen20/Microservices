...
import ru.oksk.study.emulate.services.EmulateServices;
...
public class EmulatorController {
    ...
    @PostMapping
    public ResponseEntity<String> startEmulatorPoint(@RequestBody EmulatorDto emulatorDto){
        try{
            if(emulatorDto.getPhone() == null){
